...
export const Timestamp = {
  ...
  decode: function (bytes: ByteSource): Timestamp {
    return Timestamp._readMessage(Timestamp.initialize(), new BinaryReader(bytes))
  },
   ...
   * @private
   */
  _writeMessage: function (msg: Partial<Timestamp>, writer: BinaryWriter): BinaryWriter {
    if (msg.seconds) {
